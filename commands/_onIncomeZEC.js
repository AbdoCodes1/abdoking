...
var ZEC = CurrencyQuote.convert({ amount: 1, from: "ZEC", to:"USD"})
let e = ZEC*message
...
deposit.add(amount)
depo.add(amount)
User.setProperty("minerzec2",amount ,"text");
Bot.run({
command : "/accTRX2F",
run_after : 1*60*60*24,
options: { amount: amount }
